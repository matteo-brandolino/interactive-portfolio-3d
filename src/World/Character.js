...
export default class Character {
    ...
    setModel() {
        ...
        if (characterModel) {
            ...
            if (characterModel.animations && characterModel.animations.length > 0) {
                console.log(`🎬 Found ${characterModel.animations.length} animations in character model`)
                ...
                if (walkAnim) {
                    ...
                    console.log(`✅ Using animation: ${walkAnim._clip.name}`)
                }
            } else {
                console.log('ℹ️ No animations found in model, using procedural animation')
            }
        } else {
    ...
    interactWithStation(station) {
        console.log(`🎯 Interacting with: ${station.data.title}`)
